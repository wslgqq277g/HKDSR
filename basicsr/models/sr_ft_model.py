...
class SR_ftModel(BaseModel):
    """Base SR model for single image super-resolution."""

    def __init__(self, opt):
        super(SR_ftModel, self).__init__(opt)
        ...
        self.pretrained=opt['network_g']['pretrained']
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        if with_metrics:
            ...
            self._initialize_best_metric_results(dataset_name,int(self.ft))
