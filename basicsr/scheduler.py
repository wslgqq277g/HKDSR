...
cmd1='CUDA_VISIBLE_DEVICES=0,1,2,3 \
python -m torch.distributed.launch --nproc_per_node=4 --master_port=4325 basicsr/train.py -opt options/train/RCAN/rcan_shareupkd_x2.yml --launcher pytorch'
# cmd2='CUDA_VISIBLE_DEVICES=4,5,6,7 \
# python -m torch.distributed.launch --nproc_per_node=4 --master_port=4325 train.py -opt options/train/EDSR/8_train_EDSR_kd_Mx2.yml --launcher pytorch'
